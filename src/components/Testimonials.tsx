...
const Testimonials = () => {
  const testimonials = useMemo(
    () => [
      ...
      {
        name: "Waqas Javed",
        role: "Product Manager, Starzplay Arabia",
        quote:
      ...
      {
        name: "Rehan Ahmed",
        role: "QA Manager, Starzplay Arabia",
        quote:
      ...
      {
        name: "Saad Ishtiaq",
        role: "DevOps Engineer, Lionsgate Play",
        quote:
      ...
      <div className="container mx-auto px-6">
        <header className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="mt-3 text-muted-foreground">
            Feedback from colleagues, team leads, and managers highlighting my
            technical skills, collaboration, and impact on projects.
          </p>
        </header>
